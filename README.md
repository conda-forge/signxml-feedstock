...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/signxml-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8309&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/signxml-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `signxml` can be installed with:

```
conda install signxml
```

It is possible to list all of the versions of `signxml` available on your platform with:
